            ...
            while (tempsCourant < tempsSimulation) {
                ...
                switch (evt.type) {
                    ...
                    case DORMIR: {
                        ...
                        int dureeBlocage;
                        if (evt.type == TypeEvenement.DORMIR) {
                            dureeBlocage = evt.valeur;
                        } else if (evt.type == TypeEvenement.ECRITURE) {
                            dureeBlocage = tempsEcritureDisque;
                        } else { // LECTURE
                            dureeBlocage = tempsChargePage;
                        }
